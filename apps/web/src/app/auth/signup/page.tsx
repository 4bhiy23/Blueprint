    ...
    <main className="min-h-screen flex items-center justify-center bg-[hsl(var(--background))] px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] space-y-6 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-3 text-center">
          ...
          <div>
            <h1 className="text-3xl font-black font-doodle text-[hsl(var(--foreground))]">Create Account</h1>
        ...
        <div className="border-2 border-[hsl(var(--foreground))] bg-white doodle-border-lg p-7 shadow-[5px_6px_0px_0px_hsl(var(--foreground))] space-y-5">
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div className="space-y-1 text-left">
              <Label htmlFor="name" className="text-xs font-bold font-mono text-[hsl(var(--foreground))]">Full Name</Label>
              <Input
                id="name"
                name="name"
                type="text"
            ...
            <div className="space-y-1 text-left">
              <Label htmlFor="confirmPassword" className="text-xs font-bold font-mono text-[hsl(var(--foreground))]">Confirm Password</Label>
              <Input
                id="confirmPassword"
            ...
            <Button
              disabled={loading}
              className="w-full h-11 font-mono font-bold text-xs gap-2 mt-1"
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-slate-500 font-mono text-[10px] font-bold tracking-wider">Or register with</span>
            </div>
          </div>
        ...
        <p className="text-center text-xs font-mono font-bold text-slate-600">
          ...
          <Link href="/auth/signin" className="text-[hsl(var(--primary))] hover:underline">
            Sign in
          </Link>
        </p>
      </div>
