    ...
    <main className="min-h-screen flex items-center justify-center bg-background px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-[420px] space-y-6 relative z-10">
        ...
        <div className="flex flex-col items-center space-y-3 text-center">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1 font-mono">
              [BLUEPRINT // NEW BUILDER REGISTRATION]
            </p>
          </div>
        </div>

        {/* Credentials Form Card */}
        <div className="border border-border bg-card rounded-2xl p-7 shadow-2xl space-y-5">
          <form onSubmit={handleSubmit} className="space-y-3.5">
            <div className="space-y-1 text-left">
              <Label htmlFor="name" className="text-xs font-semibold text-foreground/90">Full Name</Label>
              <Input
                id="name"
                name="name"
                type="text"
                ...
                className="bg-secondary/40 border-border focus-visible:ring-1 focus-visible:ring-[hsl(var(--mocha-mauve))] text-xs h-9"
                required
              />
            </div>
            ...
            <Button 
              disabled={loading} 
              className="w-full h-10 font-bold text-xs gap-2 bg-[hsl(var(--mocha-mauve))] text-[hsl(var(--mocha-crust))] hover:bg-[hsl(var(--mocha-mauve))/0.9] transition-all shadow-md mt-1"
            >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-3 text-muted-foreground font-mono text-[10px] tracking-wider">Or register with</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full h-9 text-xs font-medium gap-2 border-border bg-secondary/20 hover:bg-secondary/60 text-foreground"
          >
        ...
        <p className="text-center text-xs text-muted-foreground">
          ...
          <Link href="/auth/signin" className="text-[hsl(var(--mocha-mauve))] hover:underline font-bold">
            Sign in
          </Link>
        </p>
      </div>
